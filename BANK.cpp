...
class bankAccount {
    private :   
       string bankName = "KCB";  //  KARAN CODER BANK
       int bankCode; 
...
void bankAccount::createAccount() {
    ...
    balance = 500.0 ; 
    ifstream file("Karan-Coder-Bank.txt"); 
    if(file.is_open()) {

        file>>bankCode;
        file.close();
        ofstream output("Karan-Coder-Bank.txt");
...
int main (){
    ...
    do {
        cout<<"Welcome to KARAN CODER BANK"<<endl;
        cout<<"-------------------------"<<endl;
